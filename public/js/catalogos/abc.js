...
window.addEventListener('DOMContentLoaded', (event) => {
  ...
  function cargarEventListeners(){
    ...
    btnReporteBaseLine.addEventListener('click', () => {generarReporteBaseLine("individual").then((res) => {
        console.log("termino el bl GENERL ########## 1")
        console.log(res)
        console.log("termino el bl GENERL ########## 2")
        return
      })
    });
  ...
  function obtenerDatosReporteProblemasPdf(tipo_reporte = ""){
    ...
    return new Promise((resolve, reject) => {
      ...
      for (let index = 0; index < arregloDeArreglos.length; index++) {
        let arrayElementosParaReporte = arregloDeArreglos[index];
        let datosArreglo = JSON.stringify({arrayElementosParaReporte});
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          crear_repores_baseline(arregloDeArreglos_bl, tipo_reporte).then(()=>{
            ...
            $.ajax({
              url: "/inventarios/unir_reportes_baseline",
              type: "POST",
              dataType: 'json',
              data: {numero_de_reportes: arregloDeArreglos_bl.length},
              success: function (res) {
  ...
  async function crear_repores_baseline(arr_datos_bl = [], tipo_reporte = "", iteracion = 0){
