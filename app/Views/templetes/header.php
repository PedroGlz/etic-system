...
<head>
    ...
    <title>ETIC System</title>
    <link rel="shortcut icon" href="img/sistema/favicon.ico">

    <style id="size_fuente">
        *{font-size:0.9rem}
    </style>
    ...
    <!-- jsGrid -->
    <link rel="stylesheet" href="adminLTE-3.1.0/plugins/jsgrid/jsgrid.min.css">
    <link rel="stylesheet" href="adminLTE-3.1.0/plugins/jsgrid/jsgrid-theme.min.css">
    ...
    <!-- Ekko Lightbox -->
    <link rel="stylesheet" href="adminLTE-3.1.0/plugins/ekko-lightbox/ekko-lightbox.css">

    <!-- Treeview -->
    <link rel="stylesheet" href="adminLTE-3.1.0/plugins/bootstrap-treeview/bootstrap-treeview.min.css">
    ...
    <link rel="stylesheet" href="adminLTE-3.1.0/dist/css/custom.css">
